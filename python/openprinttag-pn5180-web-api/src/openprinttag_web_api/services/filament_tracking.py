...
from openprinttag_web_api.integrations.mqtt.filament_usage_publisher import publish_filament_usage_data
...
class FilamentTrackingService:
    ...
    def record_job_completion(
        ...
        """        
        _last_loaded_spool_event: EventWithTag | None = self._event_repository.get_last_event_by_event_type("success_read")
